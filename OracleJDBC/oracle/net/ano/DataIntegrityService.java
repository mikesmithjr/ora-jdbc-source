  ...
  implements AnoServices, SQLnetDef
{
    ...
    throws NetException, IOException
  {
    if (this.g)
    {
      try
      {
        this.ano.dataIntegrityAlg = (this.e = (C06)Class.forName("oracle.net.aso." + SQLnetDef.DATAINTEGRITY_CLASSNAME[this.h]).newInstance());
      }
    ...
    throws NetException, IOException
  {
    ...
    if ((this.numSubPackets != this.serviceSubPackets) && (this.numSubPackets == 8))
    {
      ...
      C09 localC09 = new C09(arrayOfByte1, arrayOfByte2, s1, s2);
      this.j = localC09.g();
      this.sAtts.ano.setClientPK(this.j);
      this.sAtts.ano.setInitializationVector(arrayOfByte4);
      this.sAtts.ano.setSessionKey(localC09.a(arrayOfByte3, arrayOfByte3.length));
    }
    this.g = (this.h > 0);
  }
}
