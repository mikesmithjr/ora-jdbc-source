...
public class LobPlsqlUtil
{
    ...
    throws SQLException
  {
    ...
    if (l1 <= getPlsqlMaxInstrSize(localOracleConnection))
    {
      ...
      try
      {
        ...
        {
          localOracleCallableStatement.setFormOfUse(2, 2);
          localOracleCallableStatement.setFormOfUse(3, 2);
        }
        ...
        l3 = localOracleCallableStatement.getLong(1);
        return l3;
      }
      finally
      {
    ...
    throws SQLException
  {
    ...
    try
    {
      ...
      {
        localOracleCallableStatement.setFormOfUse(1, 2);
        localOracleCallableStatement.setFormOfUse(4, 2);
      }
    ...
    throws SQLException
  {
    ...
    while (j == 0)
    {
      ...
      while (n != 0)
      {
        int m = (int)Math.min(32512L, l1 - i);

        arrayOfByte2 = new byte[m];

        read(paramOracleConnection, paramDatum2, paramInt, i + 1, m, arrayOfByte2);
    ...
    throws SQLException
  {
    ...
    try
    {
      localOracleCallableStatement = (OracleCallableStatement)paramConnection.prepareCall("begin dbms_lob.createTemporary (:1," + (paramBoolean ? "TRUE" : "FALSE") + ", :2); end;");
    ...
    throws SQLException
  {
    ...
    try
    {
      ...
      localOracleCallableStatement.execute();
      paramDatum.setShareBytes(localOracleCallableStatement.privateGetBytes(1));
    }
    finally
    {
      if (localOracleCallableStatement != null)
