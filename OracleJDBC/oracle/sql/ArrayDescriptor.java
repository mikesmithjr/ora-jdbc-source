  ...
  implements Serializable
{
  ...
  public ArrayDescriptor(SQLName paramSQLName, OracleTypeCOLLECTION paramOracleTypeCOLLECTION, Connection paramConnection)
    throws SQLException
  {
    super(paramSQLName, paramOracleTypeCOLLECTION, paramConnection);
  }

  public ArrayDescriptor(OracleTypeCOLLECTION paramOracleTypeCOLLECTION, Connection paramConnection)
    throws SQLException
  {
    super(paramOracleTypeCOLLECTION, paramConnection);
  }
  ...
  static ArrayDescriptor createDescriptor(SQLName paramSQLName, byte[] paramArrayOfByte1, int paramInt, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, oracle.jdbc.internal.OracleConnection paramOracleConnection, byte[] paramArrayOfByte4)
    throws SQLException
  {
    OracleTypeCOLLECTION localOracleTypeCOLLECTION = new OracleTypeCOLLECTION(paramSQLName, paramArrayOfByte1, paramInt, paramArrayOfByte2, paramArrayOfByte3, paramOracleConnection, paramArrayOfByte4);
  ...
  public int getBaseType()
    throws SQLException
  {
    int i = ((OracleTypeCOLLECTION)this.pickler).getElementType().getTypeCode();
  ...
  public int getArrayType()
    throws SQLException
  {
    int i = ((OracleTypeCOLLECTION)this.pickler).getUserCode();
  ...
  public long getMaxLength()
    throws SQLException
  {
    long l = getArrayType() == 3 ? ((OracleTypeCOLLECTION)this.pickler).getMaxLength() : 0L;
    ...
    throws SQLException
  {
    ...
    str = descType(localStringBuffer, 0);
    ...
    throws SQLException
  {
    ...
    Object localObject = paramStringBuffer.substring(0, paramStringBuffer.length());
  ...
  byte[] toBytes(ARRAY paramARRAY, boolean paramBoolean)
    throws SQLException
  {
    byte[] arrayOfByte1 = paramARRAY.shareBytes();

    if (arrayOfByte1 == null)
    {
      if ((paramARRAY.datumArray != null) || (paramARRAY.locator != null))
      {
        arrayOfByte1 = this.pickler.linearize(paramARRAY);
    ...
    {
      if ((paramARRAY.imageOffset != 0L) || (paramARRAY.imageLength != arrayOfByte1.length))
      {
        byte[] arrayOfByte2 = new byte[(int)paramARRAY.imageLength];

        System.arraycopy(arrayOfByte1, (int)paramARRAY.imageOffset, arrayOfByte2, 0, (int)paramARRAY.imageLength);

        paramARRAY.setImage(arrayOfByte2, 0L, 0L);
    ...
    throws SQLException
  {
    ...
    case 2003:
      ...
      break;
    default:
      DatabaseError.throwSqlException(1, "makeJavaArray doesn't support type " + paramInt2);
    }
