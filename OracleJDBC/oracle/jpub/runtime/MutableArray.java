...
public class MutableArray
{
    ...
    throws SQLException
  {
    ...
    return (Object)getOracleArray(paramLong, localObject);
  }
    ...
    throws SQLException
  {
    ...
    return (Object)getObjectArray(paramLong, localObject);
  }
  ...
  public void setArray(double[] paramArrayOfDouble)
  {
    if (paramArrayOfDouble == null) {
      ...
      for (int i = 0; i < this.length; i++)
        this.elements[i] = new Double(paramArrayOfDouble[i]);
    }
  }
  ...
  public void setArray(double[] paramArrayOfDouble, long paramLong) throws SQLException
  {
    ...
    for (int k = 0; k < i; k++)
    {
      setObjectElement(new Double(paramArrayOfDouble[k]), j++);
    }
  }
  ...
  public void setArray(int[] paramArrayOfInt)
  {
    if (paramArrayOfInt == null) {
      ...
      for (int i = 0; i < this.length; i++)
        this.elements[i] = new Integer(paramArrayOfInt[i]);
    }
  }
  ...
  public void setArray(int[] paramArrayOfInt, long paramLong) throws SQLException
  {
    ...
    for (int k = 0; k < i; k++)
    {
      setObjectElement(new Integer(paramArrayOfInt[k]), j++);
    }
  }
  ...
  public void setArray(float[] paramArrayOfFloat)
  {
    if (paramArrayOfFloat == null) {
      ...
      for (int i = 0; i < this.length; i++)
        this.elements[i] = new Float(paramArrayOfFloat[i]);
    }
  }
  ...
  public void setArray(float[] paramArrayOfFloat, long paramLong) throws SQLException
  {
    ...
    for (int k = 0; k < i; k++)
    {
      setObjectElement(new Float(paramArrayOfFloat[k]), j++);
    }
  }
  ...
  public void setArray(short[] paramArrayOfShort)
  {
    if (paramArrayOfShort == null) {
      ...
      for (int i = 0; i < this.length; i++)
        this.elements[i] = new Integer(paramArrayOfShort[i]);
    }
  }
  ...
  public void setArray(short[] paramArrayOfShort, long paramLong) throws SQLException
  {
    ...
    for (int k = 0; k < i; k++)
    {
      setObjectElement(new Integer(paramArrayOfShort[k]), j++);
    }
  }
  ...
  public void setObjectElement(Object paramObject, long paramLong)
    throws SQLException
  {
    OracleLog.print(this, 2048, 2, 64, "MutableArray.setObjectElement( element = " + paramObject + ",  n = " + paramLong + ")");
