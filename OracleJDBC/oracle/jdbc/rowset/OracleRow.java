    ...
    throws SQLException
  {
    ...
    try
    {
      ...
      if ((paramObject instanceof String)) {
        localObject = new String((String)paramObject);
      }
        ...
        throw new SQLException("Error, could not reproduce the copy of the object, " + paramObject.getClass().getName());
      }
    }
    catch (Exception localException)
    {
      throw new SQLException("Error while creating a copy of the column of type, " + paramObject.getClass().getName() + "\n" + localException.getMessage());
    }
