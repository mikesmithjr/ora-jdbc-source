...
public final class VersionMgr {
    ...
    public void setVersion(String paramString1, byte paramByte1, byte paramByte2, byte paramByte3,
            byte paramByte4, byte paramByte5, char paramChar, String paramString2, byte paramByte6,
            int paramInt) {
        ...
        String str1;
        if (paramChar != 0)
            str1 = paramByte1 + "." + paramByte2 + "." + paramByte3 + "." + paramByte4 + "."
                    + paramByte5 + paramChar;
        else
            str1 = paramByte1 + "." + paramByte2 + "." + paramByte3 + "." + paramByte4 + "."
                    + paramByte5;
        ...
        if (paramByte6 != 4) {
            ...
            if (paramString2 != null) {
                ...
                while (0 < i1--) {
                    j = (byte) (j + 1);
                    i = (byte) (i + 1);
                    arrayOfChar[j] = paramString2.charAt(i);
                }
 ...
 * oracle.core.lvf.VersionMgr JD-Core Version: 0.6.0
 */