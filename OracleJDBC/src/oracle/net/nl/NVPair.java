...
public final class NVPair {
    ...
    public NVPair(String paramString1, String paramString2) throws InvalidSyntaxException {
        this(paramString1);
    ...
    public void setAtom(String paramString) throws InvalidSyntaxException {
    ...
    public String modifyCommentString(String paramString) {
        ...
        while (i < paramString.length()) {
            ...
            switch (j) {
            case 92:
                if ((paramString.charAt(i + 1) != '(') && (paramString.charAt(i + 1) != '=')
 ...
 * oracle.net.nl.NVPair JD-Core Version: 0.6.0
 */