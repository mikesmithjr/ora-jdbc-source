...
public class NameResolver {
    ...
    protected NameResolver(String paramString) throws NetException {
        this.tnsAdmin = paramString;
        bootNameResolver();
    }

    public String resolveName(String paramString) throws NetException {
        if (paramString == null)
        ...
        if (this.tnsAdmin == null) {
            HostnameNamingAdapter localObject = new HostnameNamingAdapter();
    ...
    private String[] getUserReadPath() throws NetException {
        ...
        try {
            ...
            if ((localNVPair.getRHSType() != NVPair.RHS_LIST)
                    || (localNVPair.getListType() != NVPair.LIST_COMMASEP))
 ...
 * oracle.net.resolver.NameResolver JD-Core Version: 0.6.0
 */