...
public class NavDescriptionList extends DescriptionList implements NavSchemaObject {
    ...
    public void navigate(ConnStrategy paramConnStrategy, StringBuffer paramStringBuffer) {
        ...
        while (this.descProcessed < this.activeChildren.size()) {
            ((NavSchemaObject) this.activeChildren.elementAt(this.descProcessed))
                    .navigate(paramConnStrategy, paramStringBuffer);
    ...
    public static Vector setActiveChildren(Vector paramVector, boolean paramBoolean1,
