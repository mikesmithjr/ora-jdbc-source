...
public class Description implements SchemaObject {
    ...
    public void initFromNVPair(NVPair paramNVPair) throws SOException {
        ...
        for (int j = 0; j < i; j++) {
            ...
            if (this.childnv.getName().equalsIgnoreCase("SOURCE_ROUTE")) {
                this.sourceRoute = ((this.childnv.getAtom().equalsIgnoreCase("yes"))
                ...
                this.loadBalance = ((this.childnv.getAtom().equalsIgnoreCase("yes"))
                        || (this.childnv.getAtom().equalsIgnoreCase("on")) || (this.childnv
                        .getAtom().equalsIgnoreCase("true")));
            } else if (this.childnv.getName().equalsIgnoreCase("FAILOVER")) {
                this.failover = ((this.childnv.getAtom().equalsIgnoreCase("yes"))
                        || (this.childnv.getAtom().equalsIgnoreCase("on")) || (this.childnv
                        .getAtom().equalsIgnoreCase("true")));
                    ...
                    for (m = 0; m < k; m++) {
                        ...
                        if (localNVPair.getName().equalsIgnoreCase("ssl_server_cert_dn")) {
                            ...
                            if ((this.sslServerCertDN == null)
                                    || (!this.sslServerCertDN.startsWith("\""))
                                    || (!this.sslServerCertDN.endsWith("\"")))
                                continue;
                            this.sslServerCertDN = this.sslServerCertDN
                                    .substring(1, this.sslServerCertDN.length() - 1);
                        } else {
                            this.authParams.addElement(localNVPair.toString());
                        }
                    }
                }
                if ((this.childnv.getName().equalsIgnoreCase("HS"))
                        && (this.childnv.getAtom() == null))
                    try {
    ...
    public String toString() {
        ...
        if ((this.SID != null) || (this.server != null) || (this.serviceName != null)
                || (this.instanceName != null) || (this.handlerName != null)
                || (this.extraConnInfo.size() != 0) || (this.oracleHome != null)) {
 ...
 * oracle.net.TNSAddress.Description JD-Core Version: 0.6.0
 */