...
public class CustomSSLSocketFactory extends SSLSocketFactory {
    ...
    public Socket createSocket(String paramString, int paramInt1, InetAddress paramInetAddress,
        ...
        SSLSocket localSSLSocket = (SSLSocket) ossl.createSocket(paramString, paramInt1,
    ...
    public Socket createSocket(InetAddress paramInetAddress1, int paramInt1,
        ...
        SSLSocket localSSLSocket = (SSLSocket) ossl.createSocket(paramInetAddress1, paramInt1,
    ...
    public Socket createSocket(Socket paramSocket, String paramString, int paramInt,
        ...
        SSLSocket localSSLSocket = (SSLSocket) ossl.createSocket(paramSocket, paramString,
    ...
    private SSLSocket init(SSLSocket paramSSLSocket) throws IOException {
 ...
 * oracle.net.jndi.CustomSSLSocketFactory JD-Core Version: 0.6.0
 */