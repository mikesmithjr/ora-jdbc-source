...
public class ClientProfile extends Properties {
    ...
    public ClientProfile(Properties paramProperties) {
        ...
        put("oracle.net.authentication_services", paramProperties
                .getProperty("oracle.net.authentication_services", "()"));
        put("oracle.net.encryption_client", paramProperties
                .getProperty("oracle.net.encryption_client", "ACCEPTED"));
        put("oracle.net.encryption_types_client", paramProperties
                .getProperty("oracle.net.encryption_types_client", "()"));
        put("oracle.net.crypto_checksum_client", paramProperties
                .getProperty("oracle.net.crypto_checksum_client", "ACCEPTED"));
        put("oracle.net.crypto_checksum_types_client", paramProperties
                .getProperty("oracle.net.crypto_checksum_types_client", "()"));
 ...
 * oracle.net.ns.ClientProfile JD-Core Version: 0.6.0
 */