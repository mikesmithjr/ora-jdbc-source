...
public class SessionAtts implements SQLnetDef {
    ...
    public void turnEncryptionOn(NetInputStream paramNetInputStream,
            NetOutputStream paramNetOutputStream) throws NetException {
 ...
 * oracle.net.ns.SessionAtts JD-Core Version: 0.6.0
 */