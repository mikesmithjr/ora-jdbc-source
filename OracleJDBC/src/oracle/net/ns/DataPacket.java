...
public class DataPacket extends Packet implements SQLnetDef {
    ...
    protected void send(int paramInt) throws IOException {
    ...
    protected int putDataInBuffer(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
            throws IOException {
        int i = this.buffer.length - this.pktOffset <= paramInt2 ? this.buffer.length
                - this.pktOffset : paramInt2;
        if (i > 0) {
            ...
            this.availableBytesToSend = (this.dataOff < this.pktOffset ? this.pktOffset
                    - this.dataOff : 0);
        }
        return i;
    }
    ...
    protected int getDataFromBuffer(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
            throws NetException {
        int i = this.length - this.pktOffset <= paramInt2 ? this.length - this.pktOffset
                : paramInt2;
        if (i > 0) {
    ...
    protected void setBufferLength(int paramInt) throws NetException {
 ...
 * oracle.net.ns.DataPacket JD-Core Version: 0.6.0
 */