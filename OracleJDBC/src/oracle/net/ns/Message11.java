...
public class Message11 implements Message {
    ...
    private String number2string(int paramInt, String paramString) throws MissingResourceException {
        String str1 = null;
        ...
        if (paramInt > 12000) {
            if ((paramInt >= 12500) && (paramInt <= 12530))
                str1 = this.rBundle.getString("LISTENER_REFUSES_CONNECTION") + ":\n" + "ORA-"
                        + paramInt + ", " + this.rBundle.getString(String.valueOf(paramInt)) + "\n"
 ...
 * oracle.net.ns.Message11 JD-Core Version: 0.6.0
 */