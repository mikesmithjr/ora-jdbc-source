...
public class ConnOption {
    ...
    private NTAdapter getNT(Properties paramProperties) throws NetException {
        try {
            if (this.protocol.equalsIgnoreCase("tcp")) {
                ...
                this.nt = ((NTAdapter) localClass.getConstructor(arrayOfClass)
                        .newInstance(arrayOfObject));
                this.origSSLServerCertDN = this.sslServerCertDN;
                this.origServiceName = this.service_name;
                this.origSid = this.sid;
                String[] arrayOfString = { this.origSSLServerCertDN, this.origServiceName,
                        this.origSid };
    ...
    public void connect(Properties paramProperties) throws IOException {
        try {
            populateProtocol();
    ...
    public void restoreFromOrigCoption(ConnOption paramConnOption) throws IOException {
 ...
 * oracle.net.nt.ConnOption JD-Core Version: 0.6.0
 */