...
public abstract class CharacterConverters implements Serializable {
    ...
    protected abstract void storeMappingRange(int paramInt, Hashtable paramHashtable1,
            Hashtable paramHashtable2);
    ...
    public abstract String toUnicodeStringWithReplacement(byte[] paramArrayOfByte, int paramInt1,
            int paramInt2);
 ...
 * oracle.sql.converter.CharacterConverters JD-Core Version: 0.6.0
 */