...
public class LxMetaData {
    ...
    static Locale getJavaLocale(String paramString1, String paramString2) {
        ...
        String str3 = null;
        if ((paramString2 == null) || ((str3 = paramString2.toUpperCase(Locale.US)) == null)
                || ("".equals(str3))) {
    ...
    private static String getOraLocale(Locale paramLocale) {
        ...
        String str1 = paramLocale.getLanguage().equals("") ? EN_LOCALE.getLanguage() : paramLocale
                .getLanguage();
 ...
 * oracle.sql.LxMetaData JD-Core Version: 0.6.0
 */