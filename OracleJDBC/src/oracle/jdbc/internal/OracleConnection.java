...
public abstract interface OracleConnection extends oracle.jdbc.OracleConnection {
    ...
    public abstract long getTdoCState(String paramString1, String paramString2) throws SQLException;

    public abstract Datum toDatum(CustomDatum paramCustomDatum) throws SQLException;
    ...
    public abstract ResultSet newArrayDataResultSet(Datum[] paramArrayOfDatum, long paramLong,
            int paramInt, Map paramMap) throws SQLException;

    public abstract ResultSet newArrayDataResultSet(ARRAY paramARRAY, long paramLong, int paramInt,
            Map paramMap) throws SQLException;

    public abstract ResultSet newArrayLocatorResultSet(ArrayDescriptor paramArrayDescriptor,
    ...
    public abstract void getForm(OracleTypeADT paramOracleTypeADT,
            OracleTypeCLOB paramOracleTypeCLOB, int paramInt) throws SQLException;

    public abstract int CHARBytesToJavaChars(byte[] paramArrayOfByte, int paramInt,
            char[] paramArrayOfChar) throws SQLException;

    public abstract int NCHARBytesToJavaChars(byte[] paramArrayOfByte, int paramInt,
            char[] paramArrayOfChar) throws SQLException;
    ...
    public abstract int javaCharsToCHARBytes(char[] paramArrayOfChar, int paramInt,
            byte[] paramArrayOfByte) throws SQLException;

    public abstract int javaCharsToNCHARBytes(char[] paramArrayOfChar, int paramInt,
            byte[] paramArrayOfByte) throws SQLException;
    ...
    public abstract Connection getLogicalConnection(
            OraclePooledConnection paramOraclePooledConnection, boolean paramBoolean)
            throws SQLException;
    ...
    public abstract void setAbandonedTimeoutEnabled(boolean paramBoolean) throws SQLException;

    public abstract int getHeartbeatNoChangeCount() throws SQLException;

    public abstract void closeInternal(boolean paramBoolean) throws SQLException;
    ...
    public abstract void setApplicationContext(String paramString1, String paramString2,
            String paramString3) throws SQLException;

    public abstract void clearAllApplicationContext(String paramString) throws SQLException;
