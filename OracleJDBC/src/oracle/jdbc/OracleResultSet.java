...
public abstract interface OracleResultSet extends ResultSet {
    ...
    public abstract ARRAY getARRAY(String paramString) throws SQLException;

    public abstract BFILE getBfile(int paramInt) throws SQLException;

    public abstract BFILE getBFILE(int paramInt) throws SQLException;

    public abstract BFILE getBfile(String paramString) throws SQLException;

    public abstract BFILE getBFILE(String paramString) throws SQLException;

    public abstract BLOB getBLOB(int paramInt) throws SQLException;

    public abstract BLOB getBLOB(String paramString) throws SQLException;

    public abstract CHAR getCHAR(int paramInt) throws SQLException;

    public abstract CHAR getCHAR(String paramString) throws SQLException;

    public abstract CLOB getCLOB(int paramInt) throws SQLException;

    public abstract CLOB getCLOB(String paramString) throws SQLException;

    public abstract OPAQUE getOPAQUE(int paramInt) throws SQLException;

    public abstract OPAQUE getOPAQUE(String paramString) throws SQLException;

    public abstract INTERVALYM getINTERVALYM(int paramInt) throws SQLException;

    public abstract INTERVALYM getINTERVALYM(String paramString) throws SQLException;

    public abstract INTERVALDS getINTERVALDS(int paramInt) throws SQLException;

    public abstract INTERVALDS getINTERVALDS(String paramString) throws SQLException;

    public abstract TIMESTAMP getTIMESTAMP(int paramInt) throws SQLException;

    public abstract TIMESTAMP getTIMESTAMP(String paramString) throws SQLException;

    public abstract TIMESTAMPTZ getTIMESTAMPTZ(int paramInt) throws SQLException;

    public abstract TIMESTAMPTZ getTIMESTAMPTZ(String paramString) throws SQLException;

    public abstract TIMESTAMPLTZ getTIMESTAMPLTZ(int paramInt) throws SQLException;

    public abstract TIMESTAMPLTZ getTIMESTAMPLTZ(String paramString) throws SQLException;

    public abstract ResultSet getCursor(int paramInt) throws SQLException;

    public abstract ResultSet getCursor(String paramString) throws SQLException;
    ...
    /** @deprecated */
    public abstract CustomDatum getCustomDatum(String paramString,
            CustomDatumFactory paramCustomDatumFactory) throws SQLException;
    ...
    public abstract DATE getDATE(String paramString) throws SQLException;

    public abstract NUMBER getNUMBER(int paramInt) throws SQLException;

    public abstract NUMBER getNUMBER(String paramString) throws SQLException;

    public abstract Datum getOracleObject(int paramInt) throws SQLException;

    public abstract Datum getOracleObject(String paramString) throws SQLException;

    public abstract RAW getRAW(int paramInt) throws SQLException;

    public abstract RAW getRAW(String paramString) throws SQLException;

    public abstract REF getREF(int paramInt) throws SQLException;

    public abstract REF getREF(String paramString) throws SQLException;

    public abstract ROWID getROWID(int paramInt) throws SQLException;

    public abstract ROWID getROWID(String paramString) throws SQLException;

    public abstract STRUCT getSTRUCT(int paramInt) throws SQLException;

    public abstract STRUCT getSTRUCT(String paramString) throws SQLException;

    public abstract void updateARRAY(int paramInt, ARRAY paramARRAY) throws SQLException;

    public abstract void updateARRAY(String paramString, ARRAY paramARRAY) throws SQLException;

    public abstract void updateBfile(int paramInt, BFILE paramBFILE) throws SQLException;

    public abstract void updateBFILE(int paramInt, BFILE paramBFILE) throws SQLException;

    public abstract void updateBfile(String paramString, BFILE paramBFILE) throws SQLException;

    public abstract void updateBFILE(String paramString, BFILE paramBFILE) throws SQLException;

    public abstract void updateBLOB(int paramInt, BLOB paramBLOB) throws SQLException;

    public abstract void updateBLOB(String paramString, BLOB paramBLOB) throws SQLException;

    public abstract void updateCHAR(int paramInt, CHAR paramCHAR) throws SQLException;

    public abstract void updateCHAR(String paramString, CHAR paramCHAR) throws SQLException;

    public abstract void updateCLOB(int paramInt, CLOB paramCLOB) throws SQLException;

    public abstract void updateCLOB(String paramString, CLOB paramCLOB) throws SQLException;
    ...
    public abstract void updateDATE(String paramString, DATE paramDATE) throws SQLException;
    ...
    public abstract void updateNUMBER(String paramString, NUMBER paramNUMBER) throws SQLException;
    ...
    public abstract void updateRAW(String paramString, RAW paramRAW) throws SQLException;

    public abstract void updateREF(int paramInt, REF paramREF) throws SQLException;

    public abstract void updateREF(String paramString, REF paramREF) throws SQLException;

    public abstract void updateROWID(int paramInt, ROWID paramROWID) throws SQLException;

    public abstract void updateROWID(String paramString, ROWID paramROWID) throws SQLException;

    public abstract void updateSTRUCT(int paramInt, STRUCT paramSTRUCT) throws SQLException;

    public abstract void updateSTRUCT(String paramString, STRUCT paramSTRUCT) throws SQLException;
}

/*
 * Location: D:\oracle\product\10.2.0\client_1\jdbc\lib\ojdbc14_g.jar Qualified Name:
 * oracle.jdbc.OracleResultSet JD-Core Version: 0.6.0
 */