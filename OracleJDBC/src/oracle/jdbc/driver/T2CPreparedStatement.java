...
class T2CPreparedStatement extends OraclePreparedStatement {
    ...
    T2CPreparedStatement(T2CConnection conn, String sqlText, int batchValue, int rowPrefetchValue,
    ...
    void doDescribe(boolean includeNames) throws SQLException {
        if (TRACE && !OracleLog.recursiveTrace) {
            ...
            OracleLog.ociLogger.log(Level.FINE,
                                    "T2CPreparedStatement.do_describe ( includeNames = "
                                            + includeNames + ")", this);
        ...
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE, "T2CPreparedStatement.do_describe returns: void",
                                    this);
            OracleLog.recursiveTrace = false;
        }
    }
    ...
    void executeForDescribe() throws SQLException {
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE, "T2CPreparedStatement.execute_for_describe () ",
                                    this);
            OracleLog.recursiveTrace = false;
        }
        t2cOutput[0] = 0L;
        ...
        do {
            ...
            int status = T2CStatement.t2cParseExecuteDescribe(this, c_state, numberOfBindPositions,
                                                              ...
                                                              firstRowInBatch, false, needToParse,
                                                              need_to_describe, executed,
                                                              array_sql, array_sql.length, sqlKind,
                                                              ...
                                                              accessors, parameterDatum, t2cOutput,
        ...
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE,
                                    "T2CPreparedStatement.execute_for_describe () returns: void",
                                    this);
            OracleLog.recursiveTrace = false;
        }
    }
    ...
    void pushEndToEndValues() throws SQLException {
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger
                    .log(Level.FINE, "T2CPreparedStatement.pushdEndToEndValues ()", this);
            OracleLog.recursiveTrace = false;
        }
        ...
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger
                    .log(Level.FINE, "T2CPreparedStatement.pushEndToEndValues() returns: void",
                         this);
            OracleLog.recursiveTrace = false;
        }
    }
    ...
    void executeForRows(boolean executed_for_describe) throws SQLException {
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE,
                                    "T2CPreparedStatement.execute_for_rows (executed_for_describe  = "
        ...
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE,
                                    "T2CPreparedStatement.execute_for_rows () returns: void", this);
            OracleLog.recursiveTrace = false;
        }
    }
    ...
    void doDefineExecuteFetch() throws SQLException {
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE, "T2CPreparedStatement.doDefineExecuteFetch ()",
                                    this);
            OracleLog.recursiveTrace = false;
        }
        ...
        validRows = T2CStatement.t2cDefineExecuteFetch(this, c_state, numberOfDefinePositions,
                                                       ...
                                                       false, needToParse, array_sql,
                                                       array_sql.length, sqlKind, rowPrefetch,
                                                       batch, bindIndicators, bindIndicatorOffset,
                                                       bindBytes, bindChars, bindByteOffset,
                                                       bindCharOffset, queryMetaData1,
                                                       connection.queryMetaData2,
                                                       connection.queryMetaData1Offset,
                                                       connection.queryMetaData2Offset,
                                                       preparedAllBinds, preparedCharBinds,
    ...
    void fetch() throws SQLException {
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE, "T2CPreparedStatement.fetch ()", this);
            OracleLog.recursiveTrace = false;
        }
        if (numberOfDefinePositions > 0) {
            if (needToPrepareDefineBuffer) {
        ...
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger
                    .log(Level.FINE, "T2CPreparedStatement.fetch () returns: void", this);
            OracleLog.recursiveTrace = false;
        }
    }
    ...
    void doClose() throws SQLException {
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE, "T2CPreparedStatement.do_close ()", this);
            OracleLog.recursiveTrace = false;
        }
        if (defineBytes != null) {
            defineBytes = null;
        ...
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE, "T2CPreparedStatement.do_close () returns: void",
                                    this);
            OracleLog.recursiveTrace = false;
        }
    }
    ...
    void closeQuery() throws SQLException {
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE, "T2CPreparedStatement.closeQuery ()", this);
            OracleLog.recursiveTrace = false;
        }
        if (streamList != null) {
        ...
        if (TRACE && !OracleLog.recursiveTrace) {
            OracleLog.recursiveTrace = true;
            OracleLog.ociLogger.log(Level.FINE, "T2CPreparedStatement.closeQuery () returns: void",
                                    this);
            OracleLog.recursiveTrace = false;
        }
    }
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T2CPreparedStatement"));
        } catch (Exception e) {
        }
    }
}
