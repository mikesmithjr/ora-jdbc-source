...
class IntervaldsAccessor extends Accessor {
    ...
    IntervaldsAccessor(OracleStatement stmt, int max_len, short form, int external_type,
            boolean forBind) throws SQLException {
        init(stmt, 183, 183, form, forBind);
        initForDataAccess(external_type, max_len, null);
    }

    IntervaldsAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags,
            int precision, int scale, int contflag, int total_elems, short form)
            throws SQLException {
        init(stmt, 183, 183, form, false);
        initForDescribe(183, max_len, nullable, flags, precision, scale, contflag, total_elems,
                        form, null);
    ...
    Object getObject(int currentRow) throws SQLException {
        return getINTERVALDS(currentRow);
    }
 ...
 * oracle.jdbc.driver.IntervaldsAccessor JD-Core Version: 0.6.0
 */