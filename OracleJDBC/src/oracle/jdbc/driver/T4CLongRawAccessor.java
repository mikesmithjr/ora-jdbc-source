...
class T4CLongRawAccessor extends LongRawAccessor {
    ...
    T4CLongRawAccessor(OracleStatement stmt, int column_pos, int max_len, short form,
    ...
    T4CLongRawAccessor(OracleStatement stmt, int column_pos, int max_len, boolean nullable,
            int flags, int precision, int scale, int contflag, int total_elems, short form,
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CLongRawAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CLongRawAccessor JD-Core Version: 0.6.0
 */