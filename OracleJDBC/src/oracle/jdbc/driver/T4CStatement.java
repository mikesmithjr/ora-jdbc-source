...
class T4CStatement extends OracleStatement {
    ...
    void doOall8(boolean doParse, boolean doExecute, boolean doFetch, boolean doDescribe)
        ...
        this.oacdefSent = all8.marshal(doParse, doExecute, doFetch, doDescribe, this.sqlKind,
                                       ...
                                       parameterDatum, parameterOtype, this, this.ibtBindBytes,
        ...
        if (this.tmpByteArray == null) {
            if ((TRACE) && (!OracleLog.recursiveTrace)) {
                ...
                OracleLog.thinLogger.log(Level.FINER,
                                         "oracle.jdbc.driver.T4CStatement.allocateTmpByteArray : allocate byte array of size : "
            ...
            if ((TRACE) && (!OracleLog.recursiveTrace)) {
                ...
                OracleLog.thinLogger.log(Level.SEVERE,
                                         "oracle.jdbc.driver.T4CStatement.allocateTmpByteArray : Re-allocate byte array of size : "
                                                 + this.sizeTmpByteArray, this);
            ...
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINER,
                                     "oracle.jdbc.driver.T4CStatement.allocateTmpByteArray : don't re-allocate byte array of size="
                                             + this.sizeTmpByteArray + ". Current size is="
    ...
    void reparseOnRedefineIfNeeded() throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINER,
                                     "oracle.jdbc.driver.T4CStatement.reparesOrRedefineIfNeeded",
                                     this);
    ...
    Accessor allocateAccessor(int internal_type, int external_type, int col_index, int max_len,
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CStatement.allocateAccessor("
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.SEVERE,
                                     "oracle.jdbc.driver.T4CStatement.allocateAccessors:return: "
                                             + result, this);
    ...
    void doDescribe(boolean includeNames) throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE, "oracle.jdbc.driver.T4CStatement.do_describe("
                    + includeNames + ")", this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CStatement.do_describe:return", this);
    ...
    void executeForDescribe() throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            ...
            OracleLog.thinLogger
                    .log(Level.FINE, "oracle.jdbc.driver.T4CStatement.execute_for_describe()", this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CStatement.execute_for_describe:return",
                                     this);
    ...
    void executeForRows(boolean executed_for_describe) throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CStatement.execute_for_rows("
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CStatement.execute_for_rows:return: validRows = "
                                             + this.validRows, this);
    ...
    void fetch() throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE, "oracle.jdbc.driver.T4CStatement.fetch()", this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE, "oracle.jdbc.driver.T4CStatement.fetch:return",
                                     this);
    ...
    void continueReadRow(int start) throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CStatement.continueReadRow(start="
                                             + start + ")", this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger
                    .log(Level.FINE, "oracle.jdbc.driver.T4CStatement.continueReadRow:return", this);
    ...
    void doClose() throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger
                    .log(Level.FINE, "oracle.jdbc.driver.T4CStatement.do_close()", this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE, "oracle.jdbc.driver.T4CStatement.do_close:return",
                                     this);
    ...
    void closeQuery() throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE, "oracle.jdbc.driver.T4CStatement.closeQuery()",
                                     this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CStatement.closeQuery:return", this);

            OracleLog.recursiveTrace = false;
        }
    }

    T4CStatement(PhysicalConnection conn, int resultSetType, int resultSetConcurrency)
            throws SQLException {
 ...
 * oracle.jdbc.driver.T4CStatement JD-Core Version: 0.6.0
 */