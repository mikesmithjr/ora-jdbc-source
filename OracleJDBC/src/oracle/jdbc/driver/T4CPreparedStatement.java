...
class T4CPreparedStatement extends OraclePreparedStatement {
    ...
    T4CPreparedStatement(PhysicalConnection conn, String sql, int resultSetType,
        ...
        if (this.tmpByteArray == null) {
            if ((TRACE) && (!OracleLog.recursiveTrace)) {
                ...
                OracleLog.thinLogger.log(Level.FINER,
                                         "oracle.jdbc.driver.T4CPreparedStatement.allocateTmpByteArray : allocate byte array of size : "
            ...
            if ((TRACE) && (!OracleLog.recursiveTrace)) {
                ...
                OracleLog.thinLogger.log(Level.SEVERE,
                                         "oracle.jdbc.driver.T4CPreparedStatement.allocateTmpByteArray : Re-allocate byte array of size : "
                                                 + this.sizeTmpByteArray, this);
            ...
            OracleLog.thinLogger
                    .log(
                         Level.FINER,
                         "oracle.jdbc.driver.T4CPreparedStatement.allocateTmpByteArray : don't re-allocate byte array of size="
    ...
    void reparseOnRedefineIfNeeded() throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            ...
            OracleLog.thinLogger
                    .log(Level.FINER,
                         "oracle.jdbc.driver.T4CPreparedStatement.reparesOrRedefineIfNeeded", this);
    ...
    Accessor allocateAccessor(int internal_type, int external_type, int col_index, int max_len,
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.allocateAccessor("
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.SEVERE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.allocateAccessors:return: "
                                             + result, this);
    ...
    void doDescribe(boolean includeNames) throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.do_describe("
                                             + includeNames + ")", this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.do_describe:return",
                                     this);
    ...
    void executeForDescribe() throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            ...
            OracleLog.thinLogger
                    .log(Level.FINE,
                         "oracle.jdbc.driver.T4CPreparedStatement.execute_for_describe()", this);

            OracleLog.recursiveTrace = false;
        }

        this.t4Connection
                .assertLoggedOn("oracle.jdbc.driver.T4CPreparedStatement.execute_for_describe");
        cleanOldTempLobs();
        try {
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            ...
            OracleLog.thinLogger
                    .log(Level.FINE,
                         "oracle.jdbc.driver.T4CPreparedStatement.execute_for_describe:return",
                         this);
    ...
    void executeForRows(boolean executed_for_describe) throws SQLException {
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.execute_for_rows:return: validRows = "
                                             + this.validRows, this);
    ...
    void fetch() throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE, "oracle.jdbc.driver.T4CPreparedStatement.fetch()",
                                     this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.fetch:return", this);
    ...
    void continueReadRow(int start) throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.continueReadRow(start="
                                             + start + ")", this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            ...
            OracleLog.thinLogger
                    .log(Level.FINE,
                         "oracle.jdbc.driver.T4CPreparedStatement.continueReadRow:return", this);
    ...
    void doClose() throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.do_close()", this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.do_close:return",
                                     this);
    ...
    void closeQuery() throws SQLException {
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.closeQuery()", this);
        ...
        if ((TRACE) && (!OracleLog.recursiveTrace)) {
            OracleLog.recursiveTrace = true;
            OracleLog.thinLogger.log(Level.FINE,
                                     "oracle.jdbc.driver.T4CPreparedStatement.closeQuery:return",
                                     this);
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CPreparedStatement"));
        } catch (Exception e) {
        }
    }
}
