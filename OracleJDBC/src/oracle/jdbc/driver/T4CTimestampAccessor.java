...
class T4CTimestampAccessor extends TimestampAccessor {
    ...
    T4CTimestampAccessor(OracleStatement stmt, int max_len, short form, int external_type,
    ...
    T4CTimestampAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags,
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CTimestampAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CTimestampAccessor JD-Core Version: 0.6.0
 */