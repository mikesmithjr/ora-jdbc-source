...
class OracleSqlReadOnly {
    ...
    static {
        ...
        ACTION[BASE_1] = baseAction;
        ACTION[BASE_2] = baseAction;
        ACTION[B_STRING] = none;
        ACTION[B_NAME] = none;
        ACTION[B_C_COMMENT] = none;
        ACTION[B_C_COMMENT_1] = none;
        ACTION[B_COMMENT] = none;
        ACTION[PARAMETER] = parameterAction;
        ACTION[B_N_tick] = startNchar;
        ACTION[B_NCHAR] = endNchar;
        ACTION[TOKEN] = other;
        ACTION[B_EGIN] = other;
        ACTION[BE_GIN] = other;
        ACTION[BEG_IN] = other;
        ...
        ACTION[D_Eetc] = other;
        ACTION[DE_etc] = other;
        ACTION[DEC_LARE] = other;
        ACTION[DECL_ARE] = other;
        ACTION[DECLA_RE] = other;
        ACTION[DECLAR_E] = other;
        ACTION[DECLARE_] = plsql;
        ACTION[DEL_ETE] = other;
        ACTION[DELE_TE] = other;
        ACTION[DELET_E] = other;
        ACTION[DELETE_] = dml;
        ACTION[I_NSERT] = other;
        ACTION[IN_SERT] = other;
        ACTION[INS_ERT] = other;
        ACTION[INSE_RT] = other;
        ACTION[INSER_T] = other;
        ACTION[INSERT_] = dml;
        ACTION[S_ELECT] = other;
        ACTION[SE_LECT] = other;
        ACTION[SEL_ECT] = other;
        ACTION[SELE_CT] = other;
        ACTION[SELEC_T] = other;
        ACTION[SELECT_] = select;
        ACTION[U_PDATE] = other;
        ACTION[UP_DATE] = other;
        ACTION[UPD_ATE] = other;
        ACTION[UPDA_TE] = other;
        ACTION[UPDAT_E] = other;
        ACTION[UPDATE_] = dml;
        ACTION[M_ERGE ] = other;
        ACTION[ME_RGE] = other;
        ACTION[MER_GE] = other;
        ...
        ACTION[WIT_H] = other;
        ACTION[WITH_] = select;
        ACTION[KNOW_KIND] = baseAction;
        ACTION[KNOW_KIND_1] = baseAction;
        ACTION[KNOW_KIND_2] = baseAction;
        ACTION[K_STRING] = none;
        ACTION[K_NAME] = none;
        ACTION[K_C_COMMENT] = none;
        ACTION[K_C_COMMENT_1] = none;
        ACTION[K_COMMENT] = none;
        ACTION[K_PARAMETER] = kParameterAction;
        ACTION[K_N_tick] = startNchar;
        ACTION[K_NCHAR] = endNchar;

        ACTION[TOKEN_KK] = baseAction;
        ...
        ACTION[O_RDER_BY] = none;
        ACTION[OR_DER_BY] = none;
        ACTION[ORD_ER_BY] = none;
        ACTION[ORDE_R_BY] = none;
        ACTION[ORDER__BY] = order_found;

        ACTION[ORDER_xBY] = none;
        ACTION[ORDER_B_Y] = none;
        ACTION[ORDER_BY_] = order_by;

        ACTION[ORDER_xBY_CC_1] = none;
        ACTION[ORDER_xBY_CC_2] = none;
        ACTION[ORDER_xBY_CC_3] = none;
        ACTION[ORDER_xBY_C_1] = none;
        ACTION[ORDER_xBY_C_2] = none;

        ACTION[F_OR_UPDATE] = none;
        ACTION[FO_R_UPDATE] = none;
        ACTION[FOR__UPDATE] = for_found;

        ACTION[FOR_xUPDATE] = baseAction;
        ACTION[FOR_U_PDATE] = none;
        ACTION[FOR_UP_DATE] = none;
        ACTION[FOR_UPD_ATE] = none;
        ACTION[FOR_UPDA_TE] = none;
        ACTION[FOR_UPDAT_E] = none;
        ACTION[FOR_UPDATE_] = for_update;

        ACTION[FOR_xUPDATE_CC_1] = none;
        ACTION[FOR_xUPDATE_CC_2] = none;
        ACTION[FOR_xUPDATE_CC_3] = none;
        ACTION[FOR_xUPDATE_C_1] = none;
        ACTION[FOR_xUPDATE_C_2] = none;
    }
}
