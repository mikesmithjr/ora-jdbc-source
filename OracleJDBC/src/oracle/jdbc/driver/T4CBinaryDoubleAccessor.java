...
class T4CBinaryDoubleAccessor extends BinaryDoubleAccessor {
    ...
    T4CBinaryDoubleAccessor(OracleStatement stmt, int max_len, short form, int external_type,
    ...
    T4CBinaryDoubleAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags,
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CBinaryDoubleAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CBinaryDoubleAccessor JD-Core Version: 0.6.0
 */