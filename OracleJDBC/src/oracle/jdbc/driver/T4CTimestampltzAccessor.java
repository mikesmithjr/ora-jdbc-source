...
class T4CTimestampltzAccessor extends TimestampltzAccessor {
    ...
    T4CTimestampltzAccessor(OracleStatement stmt, int max_len, short form, int external_type,
    ...
    T4CTimestampltzAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags,
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CTimestampltzAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CTimestampltzAccessor JD-Core Version: 0.6.0
 */