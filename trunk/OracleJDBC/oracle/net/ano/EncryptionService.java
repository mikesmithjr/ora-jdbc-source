      ...
      try
      {
        if (d)
        {
          if (SQLnetDef.ENC_CLASSNAME_EX[this.algID].equals("DES56C"))
            ...
            this.ano.encryptionAlg = (this.e = new C12(true, SQLnetDef.CRYPTO_LEN[this.algID]));
        }
        else
