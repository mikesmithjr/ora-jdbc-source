...
public class TIMEZONETAB
{
  ...
  public static void addTrans(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    for (int j = 1; j < i * BYTE_SIZE; j += BYTE_SIZE)
    {
      ...
      k = (arrayOfInt[0] - 100) * 100 + (arrayOfInt[1] - 100);
      ...
      int m = (arrayOfInt[7] - OFFSET_HOUR) * HOUR_MILLISECOND + (arrayOfInt[8] - OFFSET_MINUTE) * MINUTE_MILLISECOND;
    ...
    throws NullPointerException, SQLException
  {
    ...
    else
    {
      ...
      else if ((localCalendar3.before(localCalendar2)) && (!localCalendar3.equals(localCalendar2)))
      {
        k--;
      }
      else if (m < n)
