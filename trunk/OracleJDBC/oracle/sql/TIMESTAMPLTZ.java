...
public class TIMESTAMPLTZ extends Datum
{
    ...
    throws SQLException
  {
    ...
    int i;
    if (localCalendar.getTimeZone().inDaylightTime(new java.sql.Date(localCalendar.getTime().getTime())))
      i = 1;
    else {
      i = 0;
    }
    ...
    throws SQLException
  {
    ...
    int i;
    if (paramCalendar.getTimeZone().inDaylightTime(new java.sql.Date(paramCalendar.getTime().getTime())))
      i = 1;
    else {
      i = 0;
    }
    ...
    throws SQLException
  {
    if (!cached)
    {
      ...
      localOraclePreparedStatement = (OraclePreparedStatement)paramConnection.prepareStatement("SELECT DBTIMEZONE FROM DUAL");
