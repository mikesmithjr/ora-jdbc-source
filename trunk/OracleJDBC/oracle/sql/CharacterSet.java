...
public abstract class CharacterSet
{
  ...
  static final void failCharacterConversion(CharacterSet paramCharacterSet)
    throws SQLException
  {
    DatabaseError.throwSqlException(55, paramCharacterSet);
  }
    ...
    throws SQLException
  {
    ...
    while (j < k)
    {
      ...
      case 7:
        if (m < n) {
          paramArrayOfChar[(m++)] = (char)(i1 & 0xFFFFFFFF); continue;
        }
      ...
      case 14:
        ...
        if (isHiSurrogate(c2))
        {
          ...
          paramArrayOfChar[(m++)] = c1; continue;
        }
    ...
    throws SQLException
  {
    ...
    while (j < k)
    {
      ...
      case 15:
        ...
        i3 = conv4ByteAL32UTF8toUTF16(i1, paramArrayOfByte[(j++)], paramArrayOfByte[(j++)], paramArrayOfByte[(j++)], paramArrayOfChar, m);
  ...
  public static final int AL16UTF16BytesToJavaChars(byte[] paramArrayOfByte, int paramInt, char[] paramArrayOfChar)
  {
    ...
    int i = 0; for (int j = 0; i < k; i++)
    {
      int m = paramArrayOfByte[j] << 8;
      paramArrayOfChar[i] = (char)(m | paramArrayOfByte[(j + 1)] & 0xFF);
    ...
    throws SQLException
  {
    ...
    {
      int m = paramArrayOfByte[j] << 8;
      char c1 = (char)(m | paramArrayOfByte[(j + 1)] & 0xFF);
      ...
      if (isHiSurrogate(c1))
      {
        ...
        if (j + 1 >= k)
          continue;
        char c2 = (char)((paramArrayOfByte[j] << 8) + (paramArrayOfByte[(j + 1)] & 0xFF));
  ...
  public static final int convertJavaCharsToAL16UTF16Bytes(char[] paramArrayOfChar, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
  {
    ...
    for (; i < k; j += 2)
    {
      ...
      paramArrayOfByte[(j + 1)] = (byte)(paramArrayOfChar[i] & 0xFF);
  ...
  public static final int convertJavaCharsToAL16UTF16LEBytes(char[] paramArrayOfChar, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
  {
    ...
    for (; i < k; j += 2)
    {
      ...
      paramArrayOfByte[(j + 1)] = (byte)(paramArrayOfChar[i] >>> '\b');
    ...
    throws SQLException
  {
    ...
    int i = paramInt2; for (int j = paramInt1; i < k; j++)
    {
    ...
    throws SQLException
  {
    for (int i = 0; i < paramInt3; i++)
    {
      ...
      else paramArrayOfByte[(paramInt2 + i)] = (byte)j;
  ...
  {
    if ((paramString == null) || (paramString.length() == 0)) return 0;
    return convertWithReplacement(paramString).length;
  }

  public int encodedByteLength(char[] paramArrayOfChar)
  {
    if ((paramArrayOfChar == null) || (paramArrayOfChar.length == 0)) return 0;
  ...
  static abstract class CharacterConverterBehavior
  {
    ...
    public static final CharacterConverterBehavior REPORT_ERROR = new CharacterSet.2("Report Error");

    public static final CharacterConverterBehavior REPLACEMENT = new CharacterSet.1("Replacement");
