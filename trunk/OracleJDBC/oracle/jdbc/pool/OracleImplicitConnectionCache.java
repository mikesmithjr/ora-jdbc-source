...
class OracleImplicitConnectionCache
{
    ...
    if (paramInt > 0)
    {
      ...
      for (int i = 0; i < paramInt; i++)
      {
        if (getTotalCachedConnections() >= this.cacheMaxLimit)
          continue;
        localOraclePooledConnection = makeCacheConnection(str1, str2);
        ...
        storeCacheConnection(str1, null, localOraclePooledConnection);
      }
    }
  }
  ...
  {
    OraclePooledConnection localOraclePooledConnection = null;
    OracleConnectionCacheEntry localOracleConnectionCacheEntry = (OracleConnectionCacheEntry)this.userMap.get(paramString1 + paramString2.toUpperCase());
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramProperties2 == null)
      {
        if (!this.cacheAttributeWeights.containsKey(localObject1))
          continue;
        i += Integer.parseInt((String)this.cacheAttributeWeights.get(localObject1)); continue;
      }
    ...
    throws SQLException
  {
    ...
    return (OraclePooledConnection)(OraclePooledConnection)localObject1;
  }
    ...
    throws SQLException
  {
    ...
    String str1 = paramOraclePooledConnection.pcUser;
    ...
    if (localOracleConnectionCacheEntry != null)
    {
      ...
      {
        String str2 = buildAttrKey(localProperties);

        Vector localVector = (Vector)localOracleConnectionCacheEntry.attrConnMap.get(str2);
      ...
      if ((this.userMap != null) && (!this.userMap.isEmpty()))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((localOracleConnectionCacheEntry.attrConnMap == null) || (localOracleConnectionCacheEntry.attrConnMap.isEmpty()))
            continue;
          Object localObject1 = localOracleConnectionCacheEntry.attrConnMap.entrySet().iterator();
    ...
    throws SQLException
  {
    ...
    case 24:
      ...
      if (getTotalCachedConnections() >= this.cacheMinLimit) break;
      i = 1; break;
    case 4096:
    ...
    throws SQLException
  {
    ...
    else if (paramInt == 24)
    {
      ...
      {
        OraclePooledConnection localOraclePooledConnection = (OraclePooledConnection)this.checkedOutConnectionList.get(j);
    ...
    throws SQLException
  {
    if (paramOraclePooledConnection != null)
    {
      ...
      try
      {
        if ((!localOracleConnection.getAutoCommit()) && (!paramOraclePooledConnection.isHostDown)) {
  ...
  private synchronized void storeCacheConnection(String paramString, Properties paramProperties, OraclePooledConnection paramOraclePooledConnection)
    throws SQLException
  {
    boolean bool = false;
    ...
    throws SQLException
  {
    ...
    if ((localOraclePooledConnection != null) && (localOraclePooledConnection.physicalConn != null))
    {
      storeCacheConnection(localOraclePooledConnection.pcUser, localOraclePooledConnection.cachedConnectionAttributes, localOraclePooledConnection);
    ...
    throws SQLException
  {
    ...
    {
      int m = this.cacheInitialLimit - i;
    ...
    throws SQLException
  {
    try
    {
      if (paramProperties != null)
      {
        ...
        Properties localProperties = (Properties)paramProperties.get("AttributeWeights");
        ...
        if (localProperties != null)
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            if (((str = (String)localProperties.get(localObject)) == null) || 
              ((i = Integer.parseInt(str)) >= 0)) continue;
            localProperties.put(localObject, "0");
          }

          if (this.cacheAttributeWeights == null) {
            this.cacheAttributeWeights = new Properties();
          }
          this.cacheAttributeWeights.putAll(localProperties);
        }
  ...
  protected int testDatabaseConnection(OracleConnection paramOracleConnection)
    throws SQLException
  {
    return paramOracleConnection.pingDatabase(0);
  }
    ...
    throws SQLException
  {
    ...
    if (str3 != null) {
      str1 = paramOraclePooledConnection.dataSourceInstanceNameKey = str3.trim().intern();
    }

    str3 = localProperties.getProperty("SERVER_HOST");
    if (str3 != null) {
      paramOraclePooledConnection.dataSourceHostNameKey = str3.trim().intern();
    }
    ...
    if (str3 != null) {
      str2 = paramOraclePooledConnection.dataSourceDbUniqNameKey = str3.trim().intern();
    }
  ...
  private int getNumberOfDefaultUserConnections()
  {
    ...
    if ((this.userMap != null) && (!this.userMap.isEmpty()))
    {
      OracleConnectionCacheEntry localOracleConnectionCacheEntry = (OracleConnectionCacheEntry)this.userMap.get(this.defaultUser + this.defaultPassword.toUpperCase());
    ...
    if (!this.isEntireServiceDownProcessed)
    {
      if ((this.userMap != null) && (!this.userMap.isEmpty()))
      {
        ...
        while (localIterator1.hasNext())
        {
          ...
          if ((this.defaultUser != null) && (this.defaultUser.equalsIgnoreCase((String)localEntry.getKey())))
          {
            i = 1;
          }
          OracleConnectionCacheEntry localOracleConnectionCacheEntry = (OracleConnectionCacheEntry)localEntry.getValue();
          ...
          while (localIterator2.hasNext())
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              if (paramBoolean1) {
                markDownConnectionsForServiceEvent(paramString1, paramString2, localOraclePooledConnection); continue;
              }
              if (paramBoolean2) {
  ...
  private boolean markDownConnectionsForHostEvent(String paramString, OraclePooledConnection paramOraclePooledConnection)
  {
    ...
    {
      paramOraclePooledConnection.connectionMarkedDown = true;
      paramOraclePooledConnection.isHostDown = true;
      i = 1;
    }
  ...
  synchronized void cleanupFailoverConnections(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (int k = 0; k < i; k++)
    {
      try
      {
        ...
        {
          if ((this.defaultUser != null) && (this.defaultUser.equalsIgnoreCase(localOraclePooledConnection.pcUser)) && (localOraclePooledConnection.cachedConnectionAttributes != null) && (localOraclePooledConnection.cachedConnectionAttributes.isEmpty()))
          {
            this.defaultUserPreFailureSize += 1;
          }
          ...
          abortConnection(localOraclePooledConnection);
          localOraclePooledConnection.isHostDown = true;
    ...
    throws SQLException
  {
    if (paramOraclePooledConnection != null)
    {
      if (paramOraclePooledConnection.isHostDown) {
    ...
    throws SQLException
  {
    ...
    if (this.databaseInstancesList != null)
    {
          ...
          if (this.countTotal > k * 1000)
          {
            for (m = 0; m < k; m++)
            {
              ...
              if ((int)(localOracleDatabaseInstance.numberOfConnectionsCount * 0.25D) >= 1) {
                localLinkedList.add(localOracleDatabaseInstance);
              }
              j = 1;
            }
      ...
      {
        this.instancesToRetireList = localLinkedList;
  ...
  protected void gravitateCache()
  {
    if (this.instancesToRetireList != null)
    {
      ...
      {
        int i = this.instancesToRetireList.size();

        for (int j = 0; j < i; j++)
        {
          this.instanceToRetire = ((OracleDatabaseInstance)this.instancesToRetireList.get(j));
