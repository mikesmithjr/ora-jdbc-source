  ...
  implements ConnectionPoolDataSource
{
    ...
    throws SQLException
  {
    ...
    localOraclePooledConnection.setUserName(!paramString1.startsWith("\"") ? paramString1.toLowerCase() : paramString1, paramString2.toUpperCase());
    ...
    throws SQLException
  {
    ...
    if (str2 == null)
      str2 = this.password;
    localOraclePooledConnection.setUserName(!str1.startsWith("\"") ? str1.toLowerCase() : str1, str2.toUpperCase());
