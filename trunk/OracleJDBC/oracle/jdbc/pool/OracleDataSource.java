  ...
  implements DataSource, Serializable, Referenceable
{
    ...
    throws SQLException
  {
    ...
    int i = 0;
    if (str4 != null) {
      ((OracleConnection)localConnection).setStatementCacheSize(i = Integer.parseInt(str4));
    }
    ...
    if (str4 != null) {
      ((OracleConnection)localConnection).setExplicitCachingEnabled(bool2 = str4.equals("true"));
    }
    ...
    if (str4 != null)
    {
      ((OracleConnection)localConnection).setImplicitCachingEnabled(bool3 = str4.equals("true"));
    }

    if ((i > 0) && (!bool2) && (!bool3))
    {
      ((OracleConnection)localConnection).setImplicitCachingEnabled(true);
      ((OracleConnection)localConnection).setExplicitCachingEnabled(true);
    }
    ...
    throws SQLException
  {
    ...
    Connection localConnection = this.odsCache.getConnection(paramString1, paramString2, paramProperties);
