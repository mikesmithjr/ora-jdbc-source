...
class LongAccessor extends CharCommonAccessor
{
    ...
    throws SQLException
  {
    ...
    if ((this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1) && (this.stream != null))
    {
      ...
      localInputStream = localPhysicalConnection.conversion.ConvertStream(this.stream, 0);
    }
    ...
    throws SQLException
  {
    ...
    if ((this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1) && (this.stream != null))
    {
      ...
      localInputStream = localPhysicalConnection.conversion.ConvertStream(this.stream, 1);
    }
    ...
    throws SQLException
  {
    ...
    if ((this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1) && (this.stream != null))
    {
      ...
      localReader = localPhysicalConnection.conversion.ConvertCharacterStream(this.stream, 9, this.formOfUse);
    }
    ...
    throws SQLException
  {
    ...
    if ((this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1) && (this.stream != null))
    {
      ...
      localInputStream = localPhysicalConnection.conversion.ConvertStream(this.stream, 6);
    }
