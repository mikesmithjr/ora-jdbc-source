...
abstract class DateTimeCommonAccessor extends Accessor
{
    ...
    throws SQLException
  {
    ...
    if (this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1)
    {
      ...
      localDate = new java.sql.Date(getMillis(j, oracleMonth(i), oracleDay(i), 0, localTimeZone));
    }
    ...
    throws SQLException
  {
    ...
    if (this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1)
    {
      ...
      paramCalendar.set(2, oracleMonth(i));
      paramCalendar.set(5, oracleDay(i));
      paramCalendar.set(11, oracleHour(i));
      paramCalendar.set(12, oracleMin(i));
      paramCalendar.set(13, oracleSec(i));
      paramCalendar.set(14, 0);

      localDate = new java.sql.Date(paramCalendar.getTime().getTime());
    }
    ...
    throws SQLException
  {
    ...
    if (this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1)
    {
      ...
      localTime = new Time(paramCalendar.getTime().getTime());
    }
    ...
    throws SQLException
  {
    ...
    if (this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1)
    {
      ...
      localTimestamp = new Timestamp(paramCalendar.getTime().getTime());
