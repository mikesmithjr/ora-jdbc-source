...
class T4C8TTIdty extends T4CTTIMsg
{
  ...
  byte[] CTcap = { 6, 1, 0, 0, 0, 1, 1, 3, 1, 1, 1, 1, 1, 0, 0, 40, -112, 3, 7, 3, 0, 1, 0, 15, 1, 0, 4, 0, 0 };
    ...
    throws SQLException, IOException
  {
    ...
    while (true)
    {
      int i = (byte)this.meg.unmarshalUB1();
  ...
  void setBasicTypes(T4CTypeRep paramT4CTypeRep)
    throws SQLException
  {
    paramT4CTypeRep.setRep(0, 0);
    paramT4CTypeRep.setRep(1, 1);
    paramT4CTypeRep.setRep(2, 1);
    paramT4CTypeRep.setRep(3, 1);
    paramT4CTypeRep.setRep(4, 1);
  }
}
