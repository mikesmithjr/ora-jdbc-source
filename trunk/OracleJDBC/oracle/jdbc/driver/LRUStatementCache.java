...
public class LRUStatementCache
{
    ...
    throws SQLException
  {
    ...
    {
      OracleStatementCacheEntry localOracleStatementCacheEntry = this.applicationCacheEnd;
      for (; this.numElements > paramInt; localOracleStatementCacheEntry = localOracleStatementCacheEntry.applicationPrev) {
  ...
  public void close()
    throws SQLException
  {
    OracleStatementCacheEntry localOracleStatementCacheEntry = this.applicationCacheStart;
    for (; localOracleStatementCacheEntry != null; localOracleStatementCacheEntry = localOracleStatementCacheEntry.applicationNext)
    {
 ...
 * Qualified Name:     oracle.jdbc.driver.LRUStatementCache
