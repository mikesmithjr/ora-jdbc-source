...
class LongRawAccessor extends RawCommonAccessor
{
    ...
    throws SQLException
  {
    ...
    if ((this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1) && (this.stream != null))
    {
      ...
      localInputStream = localPhysicalConnection.conversion.ConvertStream(this.stream, 2);
    }
    ...
    throws SQLException
  {
    ...
    if ((this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1) && (this.stream != null))
    {
      ...
      localInputStream = localPhysicalConnection.conversion.ConvertStream(this.stream, 3);
    }
    ...
    throws SQLException
  {
    ...
    if ((this.rowSpaceIndicator[(this.indicatorIndex + paramInt)] != -1) && (this.stream != null))
    {
      ...
      localReader = localPhysicalConnection.conversion.ConvertCharacterStream(this.stream, 8);
    }
