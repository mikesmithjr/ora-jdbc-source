...
public class TRANSDUMP {
    public static byte[] getTransitions(Connection paramConnection, int paramInt)
            throws SQLException {
        OracleCallableStatement localOracleCallableStatement = (OracleCallableStatement) paramConnection
                .prepareCall("begin dbms_utility.get_tz_transitions(?,?); end;");
 ...
 * oracle.sql.TRANSDUMP JD-Core Version: 0.6.0
 */