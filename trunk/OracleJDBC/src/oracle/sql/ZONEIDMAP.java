...
public class ZONEIDMAP {
    ...
    public static int getID(String paramString) {
        Integer localInteger = (Integer) zoneid.get(paramString);
    ...
    public static String getRegion(int paramInt) {
        return (String) zoneid.getKey(paramInt);
    }
    ...
    static {
        ...
        zoneid.put("EST", new Integer(1636));
        ...
        zoneid.put("UTC", new Integer(540));
        zoneid.put("MET", new Integer(367));
        zoneid.put("MST", new Integer(2662));
        zoneid.put("HST", new Integer(1474));
        ...
        zoneid.put("CST6CDT", new Integer(1125));
        ...
        zoneid.put("MST7MDT", new Integer(2150));
        ...
        zoneid.put("PST8PDT", new Integer(1127));
        ...
        zoneid.put("EST5EDT", new Integer(1124));
 ...
 * oracle.sql.ZONEIDMAP JD-Core Version: 0.6.0
 */