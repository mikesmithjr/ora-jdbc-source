...
public class CustomSSLSocketFactory {
    ...
    public static SSLSocketFactory getSSLSocketFactory(Properties paramProperties)
        ...
        if ((str11 == null)
                || ((paramProperties.get(new Integer(5)) == null) && (paramProperties
                        .get(new Integer(8)) != null))) {
            ...
            if (str1 != null) {
                ...
                if (str3 == null)
                    str3 = System.getProperty("javax.net.ssl.keyStoreType", KeyStore
                            .getDefaultType());
            ...
            if (str4 != null) {
                ...
                if (str5 == null)
                    str5 = System.getProperty("javax.net.ssl.trustStoreType", KeyStore
                            .getDefaultType());
            ...
            str9 = str1 + "#" + str3 + "#" + str2 + "#" + str4 + "#" + str5 + "#" + str6 + "#"
                    + str7 + "#" + str8;
        } else {
        ...
        try {
            ...
            if (str1 != null)
                km = getKeyManagerArray(str1, str2, str3, str7);
            if (str4 != null)
                arrayOfTrustManager = getTrustManagerArray(str4, str6, str5, str8);
            SSLContext localObject11 = SSLContext.getInstance("SSL");
            ((SSLContext) localObject11).init(km, arrayOfTrustManager, null);
            return ((SSLContext) localObject11).getSocketFactory();
    ...
    public static KeyManager[] getKeyManagerArray(String paramString1, String paramString2,
            String paramString3, String paramString4) throws IOException {
        try {
    ...
    public static TrustManager[] getTrustManagerArray(String paramString1, String paramString2,
            String paramString3, String paramString4) throws IOException {
        try {
            KeyStore localKeyStore = KeyStore.getInstance(paramString3);
            FileInputStream localFileInputStream = new FileInputStream(paramString1);
            localKeyStore.load(localFileInputStream, paramString2.toCharArray());
            TrustManagerFactory localTrustManagerFactory = TrustManagerFactory
                    .getInstance(paramString4);
    ...
    public static String processWalletLocation(String paramString) throws NetException {
        String str1 = null;
        try {
    ...
    public static String getDefaultPropertiesString() {
        ...
        if (str1 != null)
            ...
            localObject1 = System.getProperty("javax.net.ssl.keyStore", "") + "#"
 ...
 * oracle.net.nt.CustomSSLSocketFactory JD-Core Version: 0.6.0
 */