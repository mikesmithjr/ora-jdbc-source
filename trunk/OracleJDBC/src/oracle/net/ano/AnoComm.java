...
public class AnoComm implements AnoServices {
    ...
    protected void sendUB2(int paramInt) throws IOException {
        sendPktHeader(2, 3);
        writeUB2(paramInt);
    }

    protected void sendString(String paramString) throws IOException {
    ...
    protected void sendStatus(int paramInt) throws IOException {
        sendPktHeader(2, 6);
        writeUB2(paramInt);
    }

    protected void sendUB4(long paramLong) throws IOException {
        sendPktHeader(4, 4);
        writeUB4(paramLong);
    }

    protected void sendPktHeader(int paramInt1, int paramInt2) throws NetException, IOException {
    ...
    private void a(int paramInt1, int paramInt2, int paramInt3) throws NetException {
    ...
    protected void writeUB1(short paramShort) throws IOException {
    ...
    protected void sendUB2Array(int[] paramArrayOfInt) throws IOException {
    ...
    protected void writeUB2(int paramInt) throws IOException {
        byte[] arrayOfByte = new byte[2];
    ...
    private byte[] c(int paramInt) throws NetException, IOException {
    ...
    protected void writeUB4(long paramLong) throws IOException {
        byte[] arrayOfByte = new byte[4];
        int k = b((int) (0xFFFFFFFF & paramLong), arrayOfByte);
        this.j.write(arrayOfByte, 0, k);
    }

    private void d(int paramInt1, int paramInt2) throws NetException {
        if ((paramInt2 < 0) || (paramInt2 > 7))
            throw new NetException(313);
        switch (paramInt2) {
        case 0:
    ...
    private int e(byte[] paramArrayOfByte, int paramInt1, int paramInt2) throws NetException,
            IOException {
        int k = 0;
        try {
    ...
    protected void sendRaw(byte[] paramArrayOfByte) throws IOException {
    ...
    private int f(int paramInt) throws NetException, IOException {
        int k = readUB2();
        int m = readUB2();
        a(k, m, paramInt);
        return k;
    ...
    private long g(byte[] paramArrayOfByte) throws NetException, IOException {
        long l = 0L;
        try {
    ...
    protected void sendUB1(short paramShort) throws IOException {
        sendPktHeader(1, 2);
        this.j.write(0xFF & paramShort);
    }
}
 ...
 * oracle.net.ano.AnoComm JD-Core Version: 0.6.0
 */