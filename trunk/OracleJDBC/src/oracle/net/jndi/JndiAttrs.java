...
public class JndiAttrs {
    ...
    public JndiAttrs(Properties paramProperties) throws NetException {
        String str = null;
        this.env = new Properties();
        if (paramProperties.containsKey("java.naming.factory.initial"))
            this.env.put("java.naming.factory.initial", paramProperties
        ...
        if (paramProperties.containsKey("java.naming.provider.url")) {
            ...
            if (str.startsWith("ldaps")) {
                this.env.put("java.naming.ldap.factory.socket",
                             "oracle.net.jndi.CustomSSLSocketFactory");
    ...
    public Vector getProfileAttrs(String paramString) throws NetException {
        String str = "cn=";
    ...
    public Vector getAttrs(String paramString, String[] paramArrayOfString) throws NetException {
        String str = "cn=";
        Attributes localAttributes = null;
        try {
            str = str.concat(paramString);
    ...
    private Vector setAttrs(Attributes paramAttributes) throws NetException {
        ...
        if (paramAttributes == null)
            ...
            try {
                ...
                while ((localNamingEnumeration1 != null)
                        && (localNamingEnumeration1.hasMoreElements())) {
 ...
 * oracle.net.jndi.JndiAttrs JD-Core Version: 0.6.0
 */