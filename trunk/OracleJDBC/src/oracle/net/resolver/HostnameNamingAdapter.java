...
public class HostnameNamingAdapter implements NamingAdapterInterface {
    ...
    public String resolve(String paramString) throws NetException {
        int j = 0;
        int k = 0;
        int m = 0;
        int n = 0;
        ...
        try {
            ...
            String str5 = "(DESCRIPTION=(CONNECT_DATA=(SERVICE_NAME=" + str2
 ...
 * oracle.net.resolver.HostnameNamingAdapter JD-Core Version: 0.6.0
 */