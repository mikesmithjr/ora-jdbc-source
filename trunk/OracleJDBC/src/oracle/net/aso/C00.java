...
public abstract interface C00 {
    ...
    public abstract void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2) throws C03;

    public abstract int b();

    public abstract void c(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2) throws C03;

    public abstract byte[] d(byte[] paramArrayOfByte) throws C03;

    public abstract byte[] e(byte[] paramArrayOfByte) throws C03;
}

/*
 * Location: D:\oracle\product\10.2.0\client_1\jdbc\lib\ojdbc14_g.jar Qualified Name:
 * oracle.net.aso.C00 JD-Core Version: 0.6.0
 */