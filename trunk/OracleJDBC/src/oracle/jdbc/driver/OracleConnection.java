...
public abstract class OracleConnection extends OracleConnectionWrapper implements
        oracle.jdbc.internal.OracleConnection, ClientDataSupport {
    ...
    static boolean containsKey(Map d, Object o) {
        return d.get(o) != null;
    }
    ...
    /** @deprecated */
    public abstract void setClientIdentifier(String paramString) throws SQLException;

    /** @deprecated */
    public abstract void clearClientIdentifier(String paramString) throws SQLException;
}

/*
 * Location: D:\oracle\product\10.2.0\client_1\jdbc\lib\ojdbc14_g.jar Qualified Name:
 * oracle.jdbc.driver.OracleConnection JD-Core Version: 0.6.0
 */