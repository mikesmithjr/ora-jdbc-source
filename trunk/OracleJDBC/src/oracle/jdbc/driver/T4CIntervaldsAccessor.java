...
class T4CIntervaldsAccessor extends IntervaldsAccessor {
    ...
    T4CIntervaldsAccessor(OracleStatement stmt, int max_len, short form, int external_type,
            boolean forBind, T4CMAREngine _mare) throws SQLException {
        super(stmt, maxLength, form, external_type, forBind);
        this.mare = _mare;
    }

    T4CIntervaldsAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags,
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CIntervaldsAccessor"));
        } catch (Exception e) {
        }
    }
}
