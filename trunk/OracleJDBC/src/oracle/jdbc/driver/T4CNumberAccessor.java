...
class T4CNumberAccessor extends NumberAccessor {
    ...
    T4CNumberAccessor(OracleStatement stmt, int max_len, short form, int external_type,
    ...
    T4CNumberAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags,
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CNumberAccessor"));
        } catch (Exception e) {
        }
    }
}
