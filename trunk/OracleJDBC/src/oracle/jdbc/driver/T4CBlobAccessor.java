...
class T4CBlobAccessor extends BlobAccessor {
    ...
    T4CBlobAccessor(OracleStatement stmt, int max_len, short form, int external_type,
    ...
    T4CBlobAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags, int precision,
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CBlobAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CBlobAccessor JD-Core Version: 0.6.0
 */