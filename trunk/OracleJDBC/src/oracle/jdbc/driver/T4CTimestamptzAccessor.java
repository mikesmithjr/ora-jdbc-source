...
class T4CTimestamptzAccessor extends TimestamptzAccessor {
    ...
    T4CTimestamptzAccessor(OracleStatement stmt, int max_len, short form, int external_type,
    ...
    T4CTimestamptzAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags,
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CTimestamptzAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CTimestamptzAccessor JD-Core Version: 0.6.0
 */