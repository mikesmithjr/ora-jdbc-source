...
class T4CClobAccessor extends ClobAccessor {
    ...
    T4CClobAccessor(OracleStatement stmt, int max_len, short form, int external_type,
    ...
    T4CClobAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags, int precision,
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CClobAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CClobAccessor JD-Core Version: 0.6.0
 */