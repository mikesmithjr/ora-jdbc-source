...
class T4CDateAccessor extends DateAccessor {
    ...
    T4CDateAccessor(OracleStatement stmt, int max_len, short form, int external_type,
    ...
    T4CDateAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags, int precision,
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CDateAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CDateAccessor JD-Core Version: 0.6.0
 */