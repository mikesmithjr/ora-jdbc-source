...
class T4CVarcharAccessor extends VarcharAccessor {
    ...
    T4CVarcharAccessor(OracleStatement stmt, int max_len, short form, int external_type,
    ...
    T4CVarcharAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags,
            int precision, int scale, int contflag, int total_elems, short form, int _oacmxl,
        ...
        if (!this.underlyingLong) {
            ...
            if (this.mare.escapeSequenceNull(this.escapeSequenceArr[0])) {
                ...
                while (nbBytesReadTemp != -1) {
                    ...
                    nbBytesReadTemp = T4CLongAccessor
                    ...
                    if (bytesBuffer.length - nbBytesRead <= 0) {
                        continue;
                    }
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CVarcharAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CVarcharAccessor JD-Core Version: 0.6.0
 */