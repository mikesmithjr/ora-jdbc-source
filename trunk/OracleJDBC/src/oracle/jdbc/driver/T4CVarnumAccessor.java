...
class T4CVarnumAccessor extends VarnumAccessor {
    ...
    T4CVarnumAccessor(OracleStatement stmt, int max_len, short form, int external_type,
    ...
    T4CVarnumAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags,
    ...
    boolean unmarshalOneRow() throws SQLException, IOException {
        ...
        this.mare.unmarshalCLR(this.rowSpaceByte, tmpSpaceByteOffset + 1, this.meta,
                               this.byteLength - 1);
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CVarnumAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CVarnumAccessor JD-Core Version: 0.6.0
 */