...
class T4CIntervalymAccessor extends IntervalymAccessor {
    ...
    T4CIntervalymAccessor(OracleStatement stmt, int max_len, short form, int external_type,
            boolean forBind, T4CMAREngine _mare) throws SQLException {
        super(stmt, maxLength, form, external_type, forBind);
        this.mare = _mare;
    }

    T4CIntervalymAccessor(OracleStatement stmt, int max_len, boolean nullable, int flags,
        ...
        super(stmt, maxLength, nullable, flags, precision, scale, contflag, total_elems, form);
    ...
    static {
        try {
            TRACE = OracleLog.registerClassNameAndGetCurrentTraceSetting(Class
                    .forName("oracle.jdbc.driver.T4CIntervalymAccessor"));
        } catch (Exception e) {
        }
    }
}
 ...
 * oracle.jdbc.driver.T4CIntervalymAccessor JD-Core Version: 0.6.0
 */