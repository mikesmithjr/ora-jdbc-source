...
public abstract interface OracleCallableStatement extends CallableStatement,
    ...
    public abstract Object getAnyDataEmbeddedObject(int paramInt) throws SQLException;
    ...
    public abstract void registerOutParameter(int paramInt1, int paramInt2, int paramInt3,
            int paramInt4) throws SQLException;

    /** @deprecated */
    public abstract void registerOutParameterBytes(int paramInt1, int paramInt2, int paramInt3,
            int paramInt4) throws SQLException;

    /** @deprecated */
    public abstract void registerOutParameterChars(int paramInt1, int paramInt2, int paramInt3,
            int paramInt4) throws SQLException;
    ...
    public abstract Object getPlsqlIndexTable(int paramInt) throws SQLException;

    public abstract Object getPlsqlIndexTable(int paramInt, Class paramClass) throws SQLException;

    public abstract Datum[] getOraclePlsqlIndexTable(int paramInt) throws SQLException;

    public abstract void registerIndexTableOutParameter(int paramInt1, int paramInt2,
 ...
 * oracle.jdbc.OracleCallableStatement JD-Core Version: 0.6.0
 */