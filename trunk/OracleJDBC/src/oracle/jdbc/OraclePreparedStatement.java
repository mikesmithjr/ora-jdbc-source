...
public abstract interface OraclePreparedStatement extends PreparedStatement, OracleStatement {
    ...
    public abstract void setStructDescriptorAtName(String paramString,
    ...
    public abstract void setUnicodeStreamAtName(String paramString, InputStream paramInputStream,
            int paramInt) throws SQLException;
    ...
    public abstract void setObjectAtName(String paramString, Object paramObject, int paramInt1,
    ...
    public abstract void setPlsqlIndexTable(int paramInt1, Object paramObject, int paramInt2,
            int paramInt3, int paramInt4, int paramInt5) throws SQLException;
 ...
 * oracle.jdbc.OraclePreparedStatement JD-Core Version: 0.6.0
 */