...
public abstract interface OracleConnection extends Connection {
    ...
    public abstract String[] getEndToEndMetrics() throws SQLException;
    ...
    public abstract short getStructAttrCsId() throws SQLException;
    ...
    public abstract int pingDatabase(int paramInt) throws SQLException;

    public abstract void putDescriptor(String paramString, Object paramObject) throws SQLException;

    /** @deprecated */
    public abstract void registerSQLType(String paramString, Class paramClass) throws SQLException;

    /** @deprecated */
    public abstract void registerSQLType(String paramString1, String paramString2)
            throws SQLException;

    public abstract void setAutoClose(boolean paramBoolean) throws SQLException;

    public abstract void setDefaultExecuteBatch(int paramInt) throws SQLException;

    public abstract void setDefaultRowPrefetch(int paramInt) throws SQLException;
    ...
    /** @deprecated */
    public abstract void setStmtCacheSize(int paramInt) throws SQLException;

    /** @deprecated */
    public abstract void setStmtCacheSize(int paramInt, boolean paramBoolean) throws SQLException;

    public abstract void setStatementCacheSize(int paramInt) throws SQLException;

    public abstract int getStatementCacheSize() throws SQLException;

    public abstract void setImplicitCachingEnabled(boolean paramBoolean) throws SQLException;

    public abstract boolean getImplicitCachingEnabled() throws SQLException;

    public abstract void setExplicitCachingEnabled(boolean paramBoolean) throws SQLException;

    public abstract boolean getExplicitCachingEnabled() throws SQLException;

    public abstract void purgeImplicitCache() throws SQLException;

    public abstract void purgeExplicitCache() throws SQLException;

    public abstract PreparedStatement getStatementWithKey(String paramString) throws SQLException;

    public abstract CallableStatement getCallWithKey(String paramString) throws SQLException;
    ...
    /** @deprecated */
    public abstract void shutdown(int paramInt) throws SQLException;

    /** @deprecated */
    public abstract void startup(String paramString, int paramInt) throws SQLException;
    ...
    /** @deprecated */
    public abstract CallableStatement prepareCallWithKey(String paramString) throws SQLException;
    ...
    public abstract void setSessionTimeZone(String paramString) throws SQLException;
    ...
    public abstract void registerTAFCallback(OracleOCIFailover paramOracleOCIFailover,
    ...
    public abstract OracleSavepoint oracleSetSavepoint(String paramString) throws SQLException;

    public abstract void oracleRollback(OracleSavepoint paramOracleSavepoint) throws SQLException;

    public abstract void oracleReleaseSavepoint(OracleSavepoint paramOracleSavepoint)
            throws SQLException;

    public abstract void close(Properties paramProperties) throws SQLException;

    public abstract void close(int paramInt) throws SQLException;

    public abstract boolean isProxySession();

    public abstract void applyConnectionAttributes(Properties paramProperties) throws SQLException;

    public abstract Properties getConnectionAttributes() throws SQLException;

    public abstract Properties getUnMatchedConnectionAttributes() throws SQLException;

    public abstract void registerConnectionCacheCallback(
            OracleConnectionCacheCallback paramOracleConnectionCacheCallback, Object paramObject,
            int paramInt) throws SQLException;

    public abstract void setConnectionReleasePriority(int paramInt) throws SQLException;

    public abstract int getConnectionReleasePriority() throws SQLException;

    public abstract void setPlsqlWarnings(String paramString) throws SQLException;
}

/*
 * Location: D:\oracle\product\10.2.0\client_1\jdbc\lib\ojdbc14_g.jar Qualified Name:
 * oracle.jdbc.OracleConnection JD-Core Version: 0.6.0
 */